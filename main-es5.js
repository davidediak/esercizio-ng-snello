...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AbstractEditComponent = /** @class */ (function () {
                function AbstractEditComponent(service) {
                    this.service = service;
                }
                AbstractEditComponent.prototype.get = function (id) {
                    var _this = this;
                    this.service
                        .get(id)
                        .subscribe(function (element) { return _this.element = element; });
                };
                AbstractEditComponent.prototype.delete = function (id) {
                    this.service
                        .delete(id)
                        .subscribe();
                };
                AbstractEditComponent.prototype.post = function (element) {
                    this.service
                        .post(element)
                        .subscribe();
                };
                AbstractEditComponent.prototype.put = function (id, element) {
                    this.service
                        .put(id, element)
                        .subscribe();
                };
                AbstractEditComponent.prototype.goBack = function () {
                    window.history.back();
                };
                return AbstractEditComponent;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AbstractListComponent = /** @class */ (function () {
                function AbstractListComponent(service) {
                    this.service = service;
                    this.elements = [];
                }
                AbstractListComponent.prototype.getList = function () {
                    var _this = this;
                    this.service
                        .getList()
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdminAuthorsAddComponent = /** @class */ (function (_super) {
                __extends(AdminAuthorsAddComponent, _super);
                function AdminAuthorsAddComponent(authorService) {
                    var _this = _super.call(this, authorService) || this;
                    _this.authorService = authorService;
                    _this.author = new _models_author__WEBPACK_IMPORTED_MODULE_2__["Author"]();
                    return _this;
                }
                AdminAuthorsAddComponent.prototype.ngOnInit = function () {
                    console.log(this.author);
                };
                AdminAuthorsAddComponent.prototype.addAuthor = function () {
                    this.post(this.author);
                    this.goBack();
                };
                return AdminAuthorsAddComponent;
            }(_abstract_abstract_edit_component_component__WEBPACK_IMPORTED_MODULE_4__["AbstractEditComponent"]));
            AdminAuthorsAddComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdminAuthorsModifyComponent = /** @class */ (function (_super) {
                __extends(AdminAuthorsModifyComponent, _super);
                // {nome: '', cognome: ''};
                function AdminAuthorsModifyComponent(route, authorsService) {
                    var _this = _super.call(this, authorsService) || this;
                    _this.route = route;
                    _this.authorsService = authorsService;
                    _this.element = new _models_author__WEBPACK_IMPORTED_MODULE_2__["Author"]();
                    return _this;
                }
                AdminAuthorsModifyComponent.prototype.ngOnInit = function () {
                    var id = this.route.snapshot.paramMap.get('id');
                    this.get(id);
                };
                AdminAuthorsModifyComponent.prototype.modifyAuthor = function () {
                    console.log(this.element);
                    this.put(this.element.id, this.element);
                    this.goBack();
                };
                return AdminAuthorsModifyComponent;
            }(_abstract_abstract_edit_component_component__WEBPACK_IMPORTED_MODULE_5__["AbstractEditComponent"]));
            AdminAuthorsModifyComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdminAuthorsComponent = /** @class */ (function (_super) {
                __extends(AdminAuthorsComponent, _super);
                function AdminAuthorsComponent(authorsService) {
                    var _this = _super.call(this, authorsService) || this;
                    _this.authorsService = authorsService;
                    return _this;
                }
                AdminAuthorsComponent.prototype.ngOnInit = function () {
                    console.log('init');
                    this.getList();
                };
                AdminAuthorsComponent.prototype.removeAuthor = function (id) {
                    var authorToRemoveIdx = this.elements.findIndex(function (a) { return a.id === id; });
                ...
                AdminAuthorsComponent.prototype.goBack = function () {
                    window.history.back();
                };
                return AdminAuthorsComponent;
            }(_abstract_abstract_list_component_abstract_list_component_component__WEBPACK_IMPORTED_MODULE_3__["AbstractListComponent"]));
            AdminAuthorsComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _services_authors_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/authors.service */ "./src/app/services/authors.service.ts");
            /* harmony import */ var _abstract_abstract_list_component_abstract_list_component_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../abstract/abstract-list-component/abstract-list-component.component */ "./src/app/abstract/abstract-list-component/abstract-list-component.component.ts");
            var AuthorsComponent = /** @class */ (function (_super) {
                __extends(AuthorsComponent, _super);
            ...
            AuthorsComponent.ctorParameters = function () { return [
                { type: _services_authors_service__WEBPACK_IMPORTED_MODULE_2__["AuthorsService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PostComponent = /** @class */ (function () {
                function PostComponent(postsService, authorsService) {
                ...
                PostComponent.prototype.getPosts = function () {
                    var _this = this;
                    this.postsService.getList().subscribe(function (posts) {
                        posts.map(function (post) {
                            _this.postsService
                                .getAttachmentPath(post.attachments)
                                .subscribe(function (path) { return (post.pathImage = path); });
                            _this.authorsService
                                .get(post.autore_id)
                                .subscribe(function (autore) { return (post.autore = autore); });
                        });
                        console.log.apply(console, posts);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AbstractServiceService = /** @class */ (function () {
                function AbstractServiceService(url, http) {
                    this.url = url;
                    this.http = http;
                    this.baseUrl = 'http://127.0.0.1:8080/api';
                    this.url = this.baseUrl + url;
                }
                AbstractServiceService.prototype.getList = function () {
                    return this.http.get(this.url);
                };
                AbstractServiceService.prototype.get = function (id) {
                    return this.http.get(this.url + ("/" + id));
                };
                AbstractServiceService.prototype.post = function (element) {
                    return this.http.post(this.url, element);
                };
                AbstractServiceService.prototype.put = function (id, element) {
                    return this.http.put(this.url + ("/" + id), element);
                };
                AbstractServiceService.prototype.delete = function (id) {
                    return this.http.delete(this.url + ("/" + id));
                };
                return AbstractServiceService;
            }());
            AbstractServiceService.ctorParameters = function () { return [
                { type: String },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            var AttachmentsService = /** @class */ (function (_super) {
                __extends(AttachmentsService, _super);
                function AttachmentsService(http) {
                    var _this = _super.call(this, '/attachments', http) || this;
                    _this.http = http;
                    return _this;
                }
                return AttachmentsService;
            }(_abstract_service_service__WEBPACK_IMPORTED_MODULE_2__["AbstractServiceService"]));
            AttachmentsService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthorsService = /** @class */ (function (_super) {
                ...
                function AuthorsService(http) {
                    var _this = _super.call(this, '/autori', http) || this;
                    _this.http = http;
                    return _this;
                }
                return AuthorsService;
            }(_abstract_service_service__WEBPACK_IMPORTED_MODULE_2__["AbstractServiceService"]));
            AuthorsService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PostsService = /** @class */ (function (_super) {
                ...
                function PostsService(http, attachmentsService) {
                    var _this = _super.call(this, '/posts', http) || this;
                    _this.http = http;
                    _this.attachmentsService = attachmentsService;
                    _this.snelloUrl = 'http://127.0.0.1:8080/api';
                    return _this;
                }
                PostsService.prototype.getAttachmentPath = function (id) {
                    console.log('getting attachment path');
                    return this.attachmentsService
                        .get(id)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (attachment) { return attachment.path; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (attachment) { return console.log(attachment); }));
                };
                return PostsService;
            }(_abstract_service_service__WEBPACK_IMPORTED_MODULE_2__["AbstractServiceService"]));
